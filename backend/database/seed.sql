...
-- ========== CAR MODELS ==========
INSERT IGNORE INTO car_models (brand_id, model_name) VALUES
-- Toyota (brand_id = 1)
(1, 'Camry'),
(1, 'Corolla'),
(1, 'Vios'),
...
-- ========== MODEL YEARS ==========
INSERT IGNORE INTO model_years (model_id, year_number) VALUES
-- Camry (model_id = 1)
...
-- Động cơ
(1, N'Lọc dầu động cơ Toyota', N'Lọc dầu chính hãng cho các dòng xe Toyota', 150000, 100, "https://tat-filter.com/wp-content/uploads/2023/06/IMG_7910-scaled.jpg"),
(1, N'Bugi NGK Iridium', N'Bugi đánh lửa cao cấp NGK Iridium, phù hợp nhiều dòng xe', 85000, 200, "https://ngkntk.com.vn/upload/images/Iridium%201.jpg"),
(1, N'Dây curoa tổng Honda', N'Dây curoa tổng cho động cơ Honda 1.5L', 320000, 50, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQm1EdYzYyZZBpuyl385jCZtACUWOf0PL4EoA&s"),
-- Hệ thống phanh
(2, N'Má phanh trước Brembo', N'Má phanh hiệu suất cao Brembo cho sedan', 450000, 80, "https://product.hstatic.net/200000059024/product/a74791af-0fba-47c5-a42e-a6dd2c45ae54_ec0d3456c5f24cc7aec57b9ef93ea87f_master.jpg"),
(2, N'Đĩa phanh sau Toyota Camry', N'Đĩa phanh sau chính hãng cho Toyota Camry', 680000, 30, "https://cdn.hstatic.net/products/200000536179/z7153234161101_91d7de2462c9cd409b225e6edce7affa_bc757c772e6147eba83e5f6af6708b95.jpg"),
(2, N'Dầu phanh DOT4 Bosch', N'Dầu phanh Bosch DOT4 1 lít', 120000, 150, "https://down-vn.img.susercontent.com/file/vn-11134207-7ra0g-m9qv1650fr7mb9"),
-- Hệ thống điện
(3, N'Ắc quy Varta 12V 60Ah', N'Ắc quy khởi động Varta chính hãng', 1500000, 40, "https://bizweb.dktcdn.net/100/366/403/products/56030-3.jpg?v=1692690885677"),
(3, N'Bóng đèn pha LED H7', N'Bóng đèn LED H7 siêu sáng 6000K', 350000, 120, "https://auto365.vn/uploads/images/product/naoevo/s8-pro/h7/s8pro-h7.jpg"),
(3, N'Còi xe Hella Twin Tone', N'Còi xe Hella âm thanh kép chính hãng', 280000, 60, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQApHbtUADbPymAJzM08jMA2xAmW9n8cjelw&s"),
-- Thân vỏ xe
(4, N'Gương chiếu hậu trái Honda Civic', N'Gương chiếu hậu điện chỉnh cho Honda Civic', 850000, 25, "https://product.hstatic.net/200000189013/product/75d78653-b964-424d-85a9-1b4e595fcb8a_b6ac1d54c7fe4bf9bfe0f5b844fa9b08_master.jpeg"),
(4, N'Cản trước Ford Ranger', N'Cản trước nguyên bản Ford Ranger 2023', 2500000, 15, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6NRGTJaaZ4AlIQLsPcdcl9rMQx8rcRojJqA&s"),
-- Hệ thống treo
(5, N'Giảm xóc trước KYB', N'Giảm xóc trước KYB Excel-G cho sedan', 750000, 45, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmU20EHcra7H9HOFI_kMc0Setf-OmhGTSYkA&s"),
(5, N'Cao su chân máy Toyota', N'Cao su chân máy chống rung cho Toyota', 220000, 70, "https://media.loveitopcdn.com/28956/1236166040cao-su-chan-may-truoc-landcruiser-fzj100chan-may-truoc-landcruiserphu-tung-toyota-4.jpg"),
-- Hệ thống lái
(6, N'Rotuyn lái ngoài Toyota Vios', N'Rotuyn lái ngoài chính hãng cho Vios', 180000, 55, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6T6xDlhIUus5tBP-36aOt_HCbabGJkSkuGg&s"),
(6, N'Dầu trợ lực lái ATF', N'Dầu trợ lực lái tổng hợp 1 lít', 95000, 130, "https://daunhotnpoil.com/wp-content/uploads/2023/04/dau-tro-luc-tay-lai-petro-atf-iii-1-lit.jpg");
